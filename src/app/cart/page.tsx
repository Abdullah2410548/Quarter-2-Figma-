        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
              ...
              <div>
                <h3 className="text-[16px] font-normal text-[#272343] mb-3 mt-2">
                  Library Stool Chair
                </h3>
                ...
                <div className="flex gap-3 mt-3">
                  <FaRegHeart className="text-lg cursor-pointer text-[#111111]" />
                  <RiDeleteBin6Line className="text-lg text-[#111111] cursor-pointer" />
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md">
            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
              <div className="w-24 h-24 rounded overflow-hidden">
                <Image src="/update.jpeg" alt="." width={150} height={150} />
              </div>
              <div>
                <h3 className="text-[16px] font-normal text-[#272343] mb-3 mt-2">
                  Library Stool Chair
                ...
                <div className="flex gap-3 mt-3">
                  <FaRegHeart className="text-lg cursor-pointer text-black"/>
                  <RiDeleteBin6Line className="text-lg text-[#111111] cursor-pointer" />
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex justify-between mb-4">
              ...
              <p className="text-lg font-semibold text-[#111111]">Free</p>
            </div>
            <hr className="mb-4" />
